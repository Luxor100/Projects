...
(function (quickstart) {
     ...
     */
    class Signup extends quickstart.HTMLPage {
        constructor() {
            super();
            /**
             * boolean per evitare lo spam del messaggio d'errore
             */
            /*private*/ this.blockSpam = false;
            if (this.emailLabel === undefined)
                this.emailLabel = null;
            if (this.passwordLabel === undefined)
                this.passwordLabel = null;
            if (this.confermaPasswordLabel === undefined)
                this.confermaPasswordLabel = null;
            if (this.emailText === undefined)
                this.emailText = null;
            if (this.password === undefined)
                this.password = null;
            if (this.passwordConferma === undefined)
                this.passwordConferma = null;
            if (this.divEmail === undefined)
                this.divEmail = null;
            if (this.divPass === undefined)
                this.divPass = null;
            if (this.labelMadreLingua === undefined)
                this.labelMadreLingua = null;
            if (this.labelAltreLingue === undefined)
                this.labelAltreLingue = null;
            if (this.divCheckbox === undefined)
                this.divCheckbox = null;
            if (this.checkbox1 === undefined)
                this.checkbox1 = null;
            if (this.checkbox2 === undefined)
                this.checkbox2 = null;
            if (this.labelCheckboxIng === undefined)
                this.labelCheckboxIng = null;
            if (this.labelCheckboxIta === undefined)
                this.labelCheckboxIta = null;
            if (this.divSelect === undefined)
                this.divSelect = null;
            if (this.select === undefined)
                this.select = null;
            if (this.select2 === undefined)
                this.select2 = null;
            if (this.labelSelectIng === undefined)
                this.labelSelectIng = null;
            if (this.labelSelectIta === undefined)
                this.labelSelectIta = null;
            if (this.notSelected === undefined)
                this.notSelected = null;
            if (this.notSelected2 === undefined)
                this.notSelected2 = null;
            ...
            if (this.C2 === undefined)
                this.C2 = null;
            if (this.A12 === undefined)
                this.A12 = null;
            if (this.A22 === undefined)
                this.A22 = null;
            if (this.B12 === undefined)
                this.B12 = null;
            if (this.B22 === undefined)
                this.B22 = null;
            if (this.C12 === undefined)
                this.C12 = null;
            if (this.C22 === undefined)
                this.C22 = null;
            if (this.signup === undefined)
                this.signup = null;
            if (this.divSubmit === undefined)
                this.divSubmit = null;
            ...
            this.signup.onclick = (e) => {
                ...
                if (this.password.value !== this.passwordConferma.value) {
                    if (!this.blockSpam) {
                        let error = this.createLabel("Le due password non corrispondono");
